...
@Component
@Slf4j
public class AuthorityEffectIntercept implements HandlerInterceptor {
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		json.put("code", "1");
		json.put("msg", "系统异常");
		interceptMsg(response, json.toJSONString());
	}
	 ...
	 * @param json
	 */
	private void interceptMsg(HttpServletResponse response, String json) {
