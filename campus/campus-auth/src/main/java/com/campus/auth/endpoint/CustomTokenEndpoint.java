package com.campus.auth.endpoint;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.campus.common.core.constant.CommonConstants;
import com.campus.common.core.constant.PaginationConstants;
...
public class CustomTokenEndpoint {
	private static final String CAMPUS_OAUTH_ACCESS = SecurityConstants.CAMPUS_PREFIX + SecurityConstants.OAUTH_PREFIX + "auth_to_access:";
	private static final String CAMPUS_ACCESS = SecurityConstants.CAMPUS_PREFIX + SecurityConstants.OAUTH_PREFIX + "access:";
	...
	public R<Page> tokenList(@RequestBody Map<String, Object> params) {
		//根据分页参数获取对应数据
		String key = String.format("%s*:%s", CAMPUS_OAUTH_ACCESS, TenantContextHolder.getTenantId());
